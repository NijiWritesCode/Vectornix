      ...
      >
        ...
        <div className="w-full max-w-5xl z-10 -mt-6 md:-mt-10">
          ...
          <p className="max-w-2xl text-gray-200 dark:text-gray-300 mt-5 mx-auto text-sm sm:text-base md:text-lg">
            Vectornix is a platform for building and deploying AI agents that
            interact with users in a variety of ways. It supports multiple
            modalities and maintains states across interactions.
          </p>
      ...
      <main>
          ...
          <section className="text-center mt-16 px-4 sm:px-6 md:px-10 mb-20">
            <div className="max-w-2xl mx-auto">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-sm sm:text-base md:text-lg">
                Vectornix offers a range of features to help you build and
                deploy AI agents.
              </p>
            </div>
            ...
            <div className="mt-12 grid gap-6 sm:gap-8 grid-cols-1 xs:grid-cols-2 lg:grid-cols-3 justify-items-center">
              <FeatureCard
                icon={
                  <MessageCircleDashed className="w-8 h-8 sm:w-10 sm:h-10 text-blue-600" />
                }
                topic="Chat Mode"
        ...
        <Reveal>
          <section className="text-center mt-20 sm:mt-28 lg:mt-40 px-4 sm:px-6 md:px-10 mb-20">
            ...
            <div className="mt-12 grid gap-6 sm:gap-8 grid-cols-1 xs:grid-cols-2 lg:grid-cols-3 justify-items-center">
              <ShowcaseCard img={chat} topic="Chat Mode" />
              <ShowcaseCard img={search} topic="Search Mode" />
              <ShowcaseCard img={research} topic="Research Mode" />
            </div>
          </section>
        </Reveal>
